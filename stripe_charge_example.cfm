<!--- A simple one page ColdFusion example to make a charge using Stripe. --->
...
<cfset errors = [] />
  ...
  <!---
    ...
    So now it's time to charge the customer using the stripe token
  --->
  <cfif form.submitted>
    ...
    <div class="featurette-divider">
      ...
      <div class="container marketing">
        ...
        <div class="col-md-12">
          ...
          --->
          <form method="post" action="stripe_charge_example.cfm" id="payment-form">
